...
//api for all doctors list for admin
...
//api 2 get all appointment list
...
const adminDashboard = async (req, res) => {
    ...
    try {
        ...
        const dashData = {
            ...
            patients: users.length,   // changed users -> patients
