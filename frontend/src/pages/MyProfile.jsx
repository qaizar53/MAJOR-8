    ...
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
...

      {
        isEdit
          ...
          : <p className='bg-gray-50 text-3xl text-neutral mt-4' > {userData.name} </p>
      }
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 text-neutral-700'>
          ...
          <p className='font-medium'>Address:</p>
          {
            isEdit
              ? <p>
                <input className=' bg-gray-50' value={userData.address.line1} type="text" onChange={e => setUserData(prev => ({ ...prev, address: { ...prev.address, line1: e.target.value } }))} type="text" />

                <br />

                <input className=' bg-gray-50' value={userData.address.line2} type="text" onChange={e => setUserData(prev => ({ ...prev, address: { ...prev.address, line2: e.target.value } }))} type="text" />
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 text-neutral-700 mt-3'>
          ...
          {
            isEdit
              ? <select className=' max-w-20 bg-gray-100' value={userData.gender} onClick={e => setUserData(prev => ({ ...prev, gender: e.target.value }))} >
          ...
          {
            isEdit
              ? <input className='max-w-28 bg-gray-100' value={userData.dob} type='date' value={userData.dob} type="text" onChange={e => setUserData(prev => ({ ...prev, dob: e.target.value }))} />
