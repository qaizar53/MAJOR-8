        ...
        <div className='flex flex-col md:flex-row flex-wrap rounded-lg px-6 md:px-10 lg:px-20 bg-[#5f6fff]'>
            ...
            <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:-mb-7.5'>
                ...
                <div className='flex flex-col  md:flex-row items-center gap-3 text-white text-sm font-light'>
                    <img className='w-20.75' src={assets.group_profiles} alt="" />
                    <p>Simply browse through our extensive list of trusted doctors,<br className='hidden sm:block' /> schedule your appiointment hassle-free</p>
                </div>
